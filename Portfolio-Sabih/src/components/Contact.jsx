      ...
      <div className="container-padding section-padding">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center">
                  ...
                  <span className="text-gray-700">+92 333 1234567</span>
                </div>
                ...
                <div className="flex items-center justify-center">
                  ...
                  <span className="text-gray-700">sabih.mazhar@email.com</span>
                </div>
            ...
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4 text-gray-800">Professional Profiles</h3>
              <div className="flex justify-center space-x-6">
                <a 
                  href="https://www.linkedin.com/in/syed-sabih-mazhar-3a1b122b6/" 
                  target="_blank" 
                ...
                <a 
                  href="https://github.com/Engsabih" 
                  target="_blank" 
                  rel="noopener noreferrer"
